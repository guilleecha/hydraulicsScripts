...
length_cauce = 5.71  # Longitud del cauce en Km
basin_area = 7.53  # Área de la cuenca en Km²
h_max = 36.2  # Altura máxima en la cuenca en m
h_min = 1  # Altura mínima en la cuenca en m
P_3_10 = 83  # Precipitación máxima en 3 horas con un periodo de retorno de 10 años
Tr = 2  # Periodo de retorno en años
NC = 76 # Número de curva
