...
# ==========================
INPUT_FILES = [
        "./_test/cuencasur2_tr25_hydrogram.csv",
        "./_test/cuencasur2_tr100_hydrogram.csv"
]
...
TIME_MAX = 3.5  # Set upper time limit
NUM_POINTS = 500  # Number of points to sample in the final output
